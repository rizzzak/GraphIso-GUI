...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(35, 37);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(185, 28);
			this->button1->TabIndex = 1;
			this->button1->Text = L"Ввод / генерация выборки";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &MenuForm::button1_Click);
			// 
			// button2
			// 
			this->button2->Location = System::Drawing::Point(35, 80);
			...
			this->ClientSize = System::Drawing::Size(259, 129);
			this->Controls->Add(this->button2);
			this->Controls->Add(this->button1);
			this->Controls->Add(this->menuStrip1);
			this->MainMenuStrip = this->menuStrip1;
			this->MaximizeBox = false;
			this->MaximumSize = System::Drawing::Size(275, 168);
